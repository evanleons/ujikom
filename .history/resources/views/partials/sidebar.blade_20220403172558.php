      ...
      <ul class="sidebar-menu">
          ...
          <li class="nav-item dropdown">
            ...
            <ul class="dropdown-menu">
              <li><a class="nav-link" href="/list-travel"><i class="far <i class="fa-solid fa-notebook"></i>"></i>List Catatan</a></li>
              <li><a class="nav-link" href="/tambah"><i class="far fa-solid fa-square-pen"></i>Tambah Catatan</a></li>
            </ul>
          </li>
